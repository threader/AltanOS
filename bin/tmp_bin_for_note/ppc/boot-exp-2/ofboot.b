...
: bootmacos " Booting MacOS..." .printf 100 ms load-base release-load-area " /pci@f4000000/ata-6@d/disk@0:10,\\:tbxi" $boot ;
...
begin
  key? if
    key case
      ...
      ascii o of " o "(0d 0a)" .printf bootMorphOS endof
